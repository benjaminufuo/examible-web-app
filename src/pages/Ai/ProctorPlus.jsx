    ...
    <>
      ...
      <main>
        ...
        <section className="hero-section animate-fade-in-up">
          <div className="hero-text">
            <h1 className="animate-slide-in-left">
              ProctorPlus: Smart Remote Proctoring
            </h1>
            <p className="animate-slide-in-left delay-100">
              AI-powered proctoring to ensure exam integrity for schools,
              organizations, and platforms. Secure your assessments with
              intelligent, real-time monitoring.
            </p>
            <a
              href="https://proctor-plus-seven.vercel.app/"
        ...
        <section className="section feature-grid-section">
          <div className="container">
            <h2 className="section-title animate-fade-in-up">
              How ProctorPlus Works
            </h2>
            <p className="section-subtitle animate-fade-in-up delay-100">
              Leveraging cutting-edge AI, ProctorPlus provides a seamless and
              secure proctoring experience, ensuring fairness and integrity for
              every assessment.
            </p>
            <div className="feature-grid">
              <div className="feature-card animate-fade-in-up delay-200">
                ...
                <p>
                  AI-driven facial recognition and gaze tracking provide
                  real-time student monitoring, flagging suspicious activities
                  instantly.
                </p>
              </div>
              <div className="feature-card animate-fade-in-up delay-300">
                ...
                <p>
                  Securely locks down the exam environment, preventing
                  unauthorized applications and capturing all on-screen activity
                  for review.
                </p>
              </div>
              <div className="feature-card animate-fade-in-up delay-400">
                ...
                <p>
                  Intelligent audio analysis detects background noise,
                  conversations, and other anomalies, providing comprehensive
                  integrity checks.
                </p>
              </div>
              <div className="feature-card animate-fade-in-up delay-500">
                ...
                <p>
                  Generates detailed, time-stamped reports with flagged
                  incidents, making review efficient and actionable for
                  administrators.
                </p>
              </div>
            </div>
        ...
        <section className="section alternating-content-section">
          <div className="container">
            <h2 className="section-title animate-fade-in-up">
              Who Benefits from ProctorPlus?
            </h2>
            <p className="section-subtitle animate-fade-in-up delay-100">
              ProctorPlus is engineered to serve diverse needs, from academic
              institutions to corporate environments, ensuring integrity across
            ...
            <div className="content-block animate-fade-in-up">
              <div className="content-text">
                ...
                <p>
                  Safeguard the integrity of online exams and maintain academic
                  standards. ProctorPlus helps universities and schools ensure
                  fair testing conditions, reduce cheating, and uphold the value
                  of their certifications and degrees. Our solution integrates
            ...
            <div className="content-block reverse gray-bg animate-fade-in-up delay-100">
              <div className="content-text">
                ...
                <p>
                  Ensure the credibility of recruitment tests, certification
                  programs, and internal compliance exams. ProctorPlus provides
                  a secure and reliable platform for validating skills and
                  knowledge, protecting your organization's reputation and
        ...
        <section className="cta-section animate-fade-in-up">
          <div className="container">
            <h2 className="animate-fade-in-up">
              Ready to Secure Your Online Assessments?
            </h2>
            <p className="animate-fade-in-up delay-100">
              Discover how ProctorPlus can transform your exam integrity with
