...
const reasons = [
  {
    ...
    desc: "Every study plan adapts to your strengths, gaps, and goals.",
  },
  {
    Icon: FiCpu,
    title: "AI-driven support",
    desc: "Instant explanations and guidance whenever you get stuck.",
  },
  {
    Icon: FiMonitor,
    title: "Real exam simulation",
    desc: "Practice exactly like the real CBT, so exam day feels familiar.",
  },
  ...
  // { Icon: FiHeart, title: "Student engagement", desc: "Streaks, badges, and rewards keep motivation high." },
  {
    ...
    desc: "Designed around JAMB, WAEC, and NECO curricula and realities.",
  },
];
    ...
    <section className="ex-section ex-why">
      <div className="ex-container ex-why__inner">
        <Reveal className="ex-why__intro" direction="right">
          ...
          <h2 className="ex-h2">
            Built to make you{" "}
            <span className="ex-gradient-text">genuinely exam-ready</span>
          </h2>
          <p className="ex-lead">
            We combine adaptive AI, realistic practice, and motivating progress
            tracking into one platform focused entirely on African
            students&apos; success.
          </p>
          <div className="ex-why__highlight ex-card">
            <strong className="ex-gradient-text">85%</strong>
            <p>
              of consistent users report feeling more confident and prepared.
            </p>
          </div>
        </Reveal>
